...
public class Message implements Comparable<Message> {
    ...
    /**
     * Time-to-live (TTL) as seconds -setting id ({@value}). Boolean valued. If
     * set to true, the TTL is interpreted as seconds instead of minutes.
     * Default=false.
     */
     ...
     * {@link #TTL_SECONDS_S}) of the message or Integer.MAX_VALUE if the TTL is
     * infinite. Returned value can be negative if the TTL has passed already.
     *
     * @return The TTL
     */
    public int getTtl() {
